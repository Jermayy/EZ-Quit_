...
export const DashboardProgress = () => {
  ...
  const setLimit = (event) => {
    ...
    setSmokeLimit((limitRef.current.value));
    handleClose();
  ...
  return (
    <div className="dashboard">
      ...
      <Card id="metricBox">
        <Card.Body>Metrics Box</Card.Body>
      </Card>

      <Button variant="warning" className="btnInfo">
        Calendar
      </Button>
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            <InputGroup className="mb-3">
              ...
              />
              <InputGroup.Append>
                <Button variant="outline-primary" onClick={setLimit}>
                  Edit Limit
                </Button>
              </InputGroup.Append>
            </InputGroup>
